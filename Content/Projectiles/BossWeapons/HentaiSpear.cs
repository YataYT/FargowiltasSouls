...
namespace FargowiltasSouls.Content.Projectiles.BossWeapons
{
    public class HentaiSpear : ModProjectile
    {
        ...
        {
            Texture2D glow = ModContent.Request<Texture2D>("FargowiltasSouls/Content/Bosses/MutantBoss/MutantProjectiles/ MutantEye_Glow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
