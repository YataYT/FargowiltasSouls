...
namespace FargowiltasSouls.Content.Bosses.MutantBoss
{
    public class MutantSlimeBall : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (sheetClamped > 3)
                sheetClamped = 3;
            string texturePath = $"{(FargoSoulsUtil.AprilFools ? "FargowiltasSouls/Content/Bosses/MutantBoss/TextureAlts" : "FargowiltasSouls/Content/Bosses/MutantBoss/MutantProjectiles")}/MutantSlimeBall{FargoSoulsUtil.TryAprilFoolsTexture}_{sheetClamped}";
            Texture2D texture2D13 = ModContent.Request<Texture2D>(texturePath, ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
